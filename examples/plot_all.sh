...
input_files=("FCCee/vertex/Zmumu_ecm91_standard_plots/plots.root
             ...
             ")
input_files_L1=("FCCee/vertex/Zmumu_ecm91_standard_plots/plots.root
              FCCee/vertex/Zmumu_ecm91_R1.3_plots/plots.root
              FCCee/vertex/Zmumu_ecm91_R1.3_L1_w30_plots/plots.root
              FCCee/vertex/Zmumu_ecm91_R1.3_w100_plots/plots.root
              FCCee/vertex/Zmumu_ecm91_R1.3_w100_DSK_plots/plots.root
              FCCee/vertex/Zmumu_ecm91_R1.3_w50_plots/plots.root
              FCCee/vertex/Zmumu_ecm91_R1.3_w50_DSK_plots/plots.root
...
#python FCCee/vertex/plotting_leila.py -i Zmumu_ecm91_R1.3_L1_w30.root
#python FCCee/vertex/plotting_leila.py -i Zmumu_ecm91_R1.3_w30.root

python FCCee/vertex/summary_plots_leila_L1.py --analysis impact_parameter -i $input_files_L1
