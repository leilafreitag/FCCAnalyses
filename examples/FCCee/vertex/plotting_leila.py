...
def plot_raw(outDir):
    ...
    events.Draw("1e3*RP_TRK_D0>>h1","TMath::Abs(RP_MC_pdg)==13")
#    events.Draw("1e3*RP_TRK_D0>>h1","TMath::Abs(RP_TRK_D0)<0.1 && TMath::Abs(RP_MC_pdg)==13")
    ...
    events.Draw("1e3*TMath::Sqrt(RP_TRK_D0_cov)>>h2","TMath::Abs(RP_MC_pdg)==13")
#    events.Draw("1e3*TMath::Sqrt(RP_TRK_D0_cov)>>h2","TMath::Sqrt(RP_TRK_D0_cov) < 1e+1 && TMath::Abs(RP_MC_pdg)$
